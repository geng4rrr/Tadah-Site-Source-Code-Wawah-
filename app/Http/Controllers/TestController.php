...
class TestController extends Controller
{
    public function jointest(Request $request)
    {
        ...
        $joinscript = [
            ...
            'PingUrl' => 'http://api.wawah.rocks/ping',
            'PingInterval' => 120,
        ...
        $joinscript['CharacterAppearance'] = 'https://wawah.rocks/Asset/CharacterFetch.ashx?userId=' . $joinscript['UserId'];
