...
return [
    ...
    */
    ...
    'character_regeneration' => (bool) env('ENABLE_CHARACTER_REGENERATION', false),
    ...
    'user_invite_key_cost' => 15,
    'user_maximum_keys_in_window' => 2, // for ex. 3 keys every x days
    'user_invite_key_cooldown' => 365, // in days
    ...
    */
    ...
    'url' => env('APP_URL', 'http://tadah.rocks'),
