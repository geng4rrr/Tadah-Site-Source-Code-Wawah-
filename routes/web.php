...
Route::get('/about', function () { return view('documents.about'); });
...
Route::prefix('my')->middleware('auth')->group(function () {
    ...
    Route::get('/trades', [Controllers\UsersController::class, 'tradesListView'])->name('my.trades');
...
Route::get('/My/Places.aspx', function () { return view('client.landing'); });
Route::get('/Game/Help.aspx', function () { return view('client.help'); });
Route::get('/AbuseReport/InGameChat.aspx', function () { return view('client.report'); });
Route::get('/Game/Healthbar.rbxm', function () { return view('client.humanoidHealth'); });
...
// 2020 shit
Route::get('/thenewk2016', [App\Http\Controllers\ClientController::class, 'shownew'])->name('shownew');
